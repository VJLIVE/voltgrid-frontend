  ...
  <div class="min-h-screen bg-[#07090f] flex flex-col">
    ...
    <div class="relative z-10 flex flex-col min-h-screen">
      ...
      <div class="px-6 py-5 flex items-center justify-between border-b border-[#1e2d3d]">
        ...
        <RouterLink to="/register" class="text-sm text-slate-500 hover:text-white transition-colors">
          No account? <span class="text-blue-400">Register →</span>
        </RouterLink>
      </div>
      ...
      <div class="flex-1 flex items-center justify-center px-4 py-16">
        <div class="w-full max-w-md">
          <!-- Header -->
          <div class="mb-8">
            <h1 class="font-syne text-3xl font-bold text-white mb-2">Welcome back</h1>
            <p class="text-slate-500 text-sm">Sign in to your VoltGrid operator account.</p>
          </div>
          ...
          <p class="text-center text-sm text-slate-600 mt-6">
            ...
            <RouterLink to="/register" class="text-blue-400 hover:text-blue-300 transition-colors ml-1">Create one</RouterLink>
          </p>
        </div>
      </div>
    </div>
